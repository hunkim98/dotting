...
import { Clear, ColorPixels, GridInformation } from "./useDottingComponents";
...
With `useDotting`, you can manipulate the grid and also get information of the pixels in the grid.

#### Methods provided by `useDotting`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`colorPixels(data: PixelModifyData)`</td>
      <td>
...
#### 1. Change Pixel Color Example `colorPixels(data: PixelModifyData)`
...
#### 3. Get Grid Information Example `gridIndices`, `dimensions`
