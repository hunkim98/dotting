...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `AddGridIndicesParams` is defined as follows:
        ```ts
    ...
    <tr>
      ...
      <td>
        `DeleteGridIndicesParams` is defined as follows:
        ```ts
...
#### 3. Clear Example `clear()`

With `clear` method, you can clear all the pixels in the grid.

<Clear />

#### 4. Set Indicator Pixels `setIndicatorPixels(data: Array<PixelModifyItem>)`
...
#### 5. Undo and Redo Example `undo()`, `redo()`
