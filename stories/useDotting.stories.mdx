...
<table>
  ...
  <tbody>
    ...
    <tr>
    <td>`getCustomBackGroundCanvas`</td>
      <td>
        Returns a custom background canvas that a user can manipulate
      </td>
      <td>
      </td>
    </tr>
    <tr>
    <td>`getCustomForeGroundCanvas`</td>
      <td>
        Returns a custom foreground canvas that a user can manipulate
      </td>
      <td>
      </td>
    </tr>
