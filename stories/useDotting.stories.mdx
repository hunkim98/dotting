...
<table>
  ...
  <tbody>
    ...
    <tr>
    <td>`getBackgroundCanvas`</td>
      <td>
        Returns a customizable background canvas that a user can manipulate
      </td>
      <td>
      </td>
    </tr>
    <tr>
    <td>`getForegroundCanvas`</td>
      <td>
        Returns a customizable foreground canvas that a user can manipulate
      </td>
      <td>
      </td>
    </tr>
    <tr>
    <td>`convertWorldPosToCanvasOffset`</td>
      <td>
        Returns the canvas offset for the given world position. The left top corner world position of canvas is (0, 0).
      </td>
      <td>
      `x`: number, `y`: number
      </td>
