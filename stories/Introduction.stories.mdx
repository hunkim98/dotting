...
import CustomExample from "./custom/CustomExample";
...
Dotting works for **both PC and moible environments**. You can freely pan & zoom around the using your mouse or your fingers.
...
Step 2. Implement the component in your React project
